...
export const registraProyecto = async(peticion, respuesta)=>{
    try {
        ...
        const [resultado] = await objetoConexion.query('INSERT INTO proyecto (descripcion, monto, fechaInicio, fechaFin, estado, persona_idPersona) VALUES (?,?,?,?,?,?)',
            [peticion.body.descripcion, peticion.body.monto, peticion.body.fechaInicio, peticion.body.fechaFin, peticion.body.estado, idPersona]
        );
...
export const actualizarProyecto = async (peticion, respuesta)=> {
    try{
        ...
        const [resultado] = await objetoConexion.query(
            ...
            [peticion.body.descripcion, peticion.body.monto, peticion.body.fechaInicio, peticion.body.fechaFin, peticion.body.estado, idPersona, peticion.body.idProyecto]
        );
        console.log(resultado);
        respuesta.json({resultado});
    }catch (e) {
