 ...
 * rutas peticiones 
 */
import {registraEgreso, consultaEgresos, actualizarEgreso, eliminarEgreso, consultaSaldo} from "../controllers/4-registros_egresos-controllers";
 ...
 * Rutas
 */
router.post(`/registro`, sesionExistente, consultaSaldo, registraEgreso);
